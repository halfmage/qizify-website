module.exports = {
    en: {
        ...
        Content_1_Title: "How LearnSlice helps learning", 
        ...
        Use_Case_Subtitle: "LearnSlice is ideal for gamified homework, seminar exercises, exam preparation, personalized self-learning, and peer-to-peer learning for better grades.",
        Use_Case_1_Title: "Formative Assessments",
        Use_Case_1_Text: "LearnSlice is a platform for creating and administering interactive quizzes. It helps educators design engaging assessments, automatically grades them, and provides instant feedback to students, saving time for educators.",
        Use_Case_2_Title: "Quiz as homework",
        Use_Case_2_Text: "LearnSlice can be used for homework assignments, where learners create quizzes beforehand and present them during the class. By presenting their quizzes to peers, learners engage in collaborative learning, fostering active participation and deeper understanding of the subject matter.",
    ...
    de: {
        ...
        Content_1_Title: "Wie LearnSlice beim Lernen hilft", 
        ...
        Use_Case_Subtitle: "LearnSlice ist ideal für gamifizierte Hausaufgaben, Übungen im Seminar, Prüfungsvorbereitung, personalisiertes Selbstlernen und Peer-to-Peer-Lernen zur Verbesserung der Noten.",
        Use_Case_1_Title: "Formative Assessments",
        Use_Case_1_Text: "LearnSlice ist eine Plattform zur Erstellung und Durchführung interaktiver Quizze. Sie unterstützt Pädogoge dabei, ansprechende Bewertungen zu entwerfen und gibt den Lernenden sofortiges Feedback, was Zeit für Pädagogen spart.",
