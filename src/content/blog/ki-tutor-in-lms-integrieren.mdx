...
<img src="/images/blog/lms-ai-reach-de.svg" alt="Diagramm: Jede eingebaute KI-Aktion arbeitet auf der Seite, die der Lernende offen hat, während die Kursbibliothek jenseits einer Grenze liegt, die keine Aktion überschreitet" style={{ maxWidth: '580px', width: '100%', display: 'block', margin: '2rem auto' }} />
...
<img src="/images/blog/grounding-two-routes-de.svg" alt="Diagramm: Dieselbe Frage auf zwei Wegen. Direkt zum Modell entsteht eine selbstbewusste, erfundene Antwort. Zuerst über den Suchindex entsteht eine Antwort mit Verweis auf Modul 4.2, Abschnitt 3" style={{ maxWidth: '580px', width: '100%', display: 'block', margin: '2rem auto' }} />
...
<img src="/images/blog/tutor-layer-not-migration-de.svg" alt="Diagramm: Ihr LMS behält Kurse, Einschreibungen, Notenbuch, Zertifikate und Reporting, während die neue Lernbegleiter-Schicht Suchindex, Gedächtnis, Bewertung und Leitplanken ergänzt, angebunden über LTI 1.3" style={{ maxWidth: '580px', width: '100%', display: 'block', margin: '2rem auto' }} />
