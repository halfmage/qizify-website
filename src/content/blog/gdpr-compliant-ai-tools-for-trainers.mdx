...
If you want to check how a vertical apprenticeship platform covers these seven checks in concrete terms (with a data processing agreement, EU hosting, and a use-case-specific data flow), you will find a detailed overview and demo access at [LearnSlice for companies](/companies). For a broader picture of generative AI in dual vocational training, see the article on [AI in vocational training](/blog/ai-in-vocational-training). And to remove the third-country transfer entirely by running the model on your own infrastructure, see [custom AI on open-source models](/blog/custom-ai-open-source-models).
