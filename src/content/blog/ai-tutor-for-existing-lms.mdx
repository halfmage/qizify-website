...
<img src="/images/blog/lms-ai-reach.svg" alt="Diagram: every built-in AI action works on the page the learner already has open, while the course library sits on the other side of a barrier the actions never cross" style={{ maxWidth: '580px', width: '100%', display: 'block', margin: '2rem auto' }} />
