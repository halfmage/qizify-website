...
![Azubi an einer CNC-Maschine während einer praktischen Übung](/images/blog/pexels-mikhail-nilov-9242206.webp)
...
- **Atemübung 4-7-8** - 4 Sekunden einatmen, 7 Sekunden halten, 8 Sekunden ausatmen. Drei Wiederholungen senken den Puls spürbar.
...
**Möchten Sie Ihre Azubis optimal auf die IHK-Prüfung vorbereiten? [Buchen Sie eine kostenlose Demo von LearnSlice](/de/companies) und erleben Sie KI-gestützte Prüfungsvorbereitung, die an IHK-Themenbereichen und -Format orientiert ist. Oder berechnen Sie zuerst Ihr Einsparpotenzial mit unserem [Ausbildungskosten-Rechner](/de/ausbildungskosten-rechner).**
