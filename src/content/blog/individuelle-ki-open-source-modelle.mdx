...
| Setup | Betreibt grob | Richtwert EU-Kosten |
|---|---|---|
| Einzelne Mittelklasse-GPU | ein 20- bis 30B-Modell, quantisiert | niedrige Hunderte Euro pro Monat |
| Einzelner GPU-Server mit viel Speicher | ein 120B-Modell (z. B. gpt-oss) | ab ca. 900 Euro pro Monat |
| Multi-GPU-Knoten | die größten offenen Modelle (ab 200B) | vierstellig pro Monat und mehr |

*Die Preis- und Hardware-Angaben oben sind Richtwerte, Stand 2026; beides ändert sich schnell.*
