...
Auf unabhängigen Benchmarks wie dem [Artificial Analysis Intelligence Index](https://artificialanalysis.ai/models/open-source) kommen die stärksten Open-Weight-Modelle Mitte 2026 überwiegend von chinesischen Laboren (Moonshots Kimi, DeepSeek, Alibabas Qwen, MiniMax und Z.AIs GLM), mit Mistral als führendem europäischen Vertreter und Googles Gemma als weiterer westlicher Option ([eine Übersicht von Mitte 2026](https://officechai.com/ai/top-open-source-ai-models/) fasst denselben Index zusammen). Für einen EU-Käufer ist genau dieses Muster ein Grund zum Self-Hosting, nicht zum Verzicht auf diese Modelle: Wenn Sie die offenen Gewichte auf Ihrer eigenen EU-Infrastruktur betreiben, bleiben Ihre Daten in der EU, unabhängig davon, wo das Modell trainiert wurde. Und wenn die Herkunft des Modells selbst zählt, ist Mistral eine in der EU ansässige Option unter einer sauberen Lizenz.
