...
faq:
  - q: "Is a digital training logbook legally valid in Germany?"
    a: "Yes. Section 13 of the Vocational Training Act does not prescribe a specific format, and since 2020 the legal framework explicitly permits digital training logbooks. All IHK chambers accept them. The content requirements are identical to paper; only the implementation differs."
  - q: "How often does the training logbook have to be filled in?"
    a: "Entries have to be created promptly, as a rule weekly. This is where paper most often fails: apprentices catch up weeks or months at a time and entries end up missing. Automatic reminders for entries that are due are the single biggest practical advantage of going digital."
  - q: "What happens if the training logbook is incomplete?"
    a: "A properly maintained logbook is a prerequisite for admission to the final examination. If it is missing or has gaps, the apprentice can be denied access to the exam. The complete record therefore has to be available in time for exam registration."
  - q: "Does a digital training logbook need a handwritten signature?"
    a: "No. Digital sign-off by both the apprentice and the trainer is accepted by all IHK chambers, provided the system ensures authenticity and traceability. What matters is that trainers review and approve entries regularly, not the form the signature takes."
  - q: "What should a digital solution be able to do?"
    a: "Templates that match the requirements of the competent chamber, automatic reminders for entries that are due, digital approval with no switch back to paper, a clean PDF export in a chamber-compliant format, and audit-proof archiving through to the final examination. On data protection, look for EU hosting and a role model that separates apprentice, trainer, and administration."
  - q: "Who has to agree to keeping the record digitally?"
    a: "The training company. It is best to record electronic record keeping in the training contract before you switch. For existing contracts, check the agreed form of the training record first."
---
