---
title: "Ausbildungsrahmenplan: Trainer Guide + Conversion Table"
description: "What the Ausbildungsrahmenplan regulates, how it is structured, and how to turn it into a company-specific plan. With a conversion table to copy."
...
## Conversion Table: Moving Framework Plan Positions Into the Company Plan

The five steps above fit into a table you set up once per occupation and then copy per apprentice. Section A is already filled in: the four standard occupational profile positions apply in every occupation modernised since 1 August 2021 and have to be covered regardless.

<CopyBlock buttonLabel="Copy table" copiedLabel="Copied!">

### Ausbildungsrahmenplan: Conversion Table

*Occupation:* [designation per training ordinance]
*Training ordinance dated:* [date, BGBl. Part I reference]
*Version checked on:* [date] · *Prepared by:* [name]

#### A. Standard Occupational Profile Positions (mandatory since 01.08.2021)

| Position per framework plan | Department / location | Responsible | Year / half |
|---|---|---|---|
...
#### B. Occupation-Specific Positions

One row per position from your occupation's framework plan. Copy the wording unchanged so the mapping back to the training ordinance stays traceable.

| Ref. | Skill to be taught (verbatim) | Timeframe | Department / responsible | Year / half |
|---|---|---|---|---|
...
The table captures the mapping, not the learning progress. That is exactly what § 14 BBiG asks for, and exactly what it cannot do day to day: once several occupations, locations, or intakes are in play, the upkeep grows faster than the benefit.
...
Companies training their own apprentices are usually well served by a finished platform. Training providers, universities, and course operators preparing large groups for a regulated exam need the same structure inside their own systems and under their own brand. Our page on [custom e-learning development](/solutions) sets out how that gets built.
