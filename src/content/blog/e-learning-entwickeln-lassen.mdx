---
title: "Was kostet E-Learning entwickeln lassen? Preise 2026"
description: "Was E-Learning entwickeln lassen 2026 kostet: Preisrichtwerte für Modul, Plattform und KI-Tutor, dazu Projektablauf und Anbieter-Checkliste."
...
## Wann sich Individualentwicklung lohnt

Individualentwicklung lohnt sich, sobald Standardsoftware Ihre Anforderungen nicht mehr abdeckt: wenn die Inhalte zu speziell sind, die Abläufe zu individuell, die Datenschutzanforderungen zu hoch oder wenn Sie KI und eigenes Unternehmenswissen einbinden wollen.
...
Genau darum geht es in diesem Leitfaden: **was eine Individualentwicklung wirklich kostet**, der realistische Ablauf und die Kriterien, die bei der Anbieterwahl zählen.
...
## Bewertungsbogen zum Kopieren

Die Kriterien oben helfen nur, wenn Sie sie bei jedem Anbieter gleich anlegen. Vergeben Sie 0 (fehlt) bis 3 (mit Belegen nachgewiesen), dann entscheidet sich die engere Auswahl meist von selbst. Abschnitt zwei und drei sind das, was ein Anbieter von Ihnen braucht, damit Angebote überhaupt vergleichbar werden.

<CopyBlock buttonLabel="Bewertungsbogen kopieren" copiedLabel="Kopiert!">

### E-Learning-Anbieter: Bewertungsbogen

*Projekt:* [Kurzbeschreibung] · *Bewertet am:* [Datum] · *Bewertet von:* [Name]

#### 1. Anbietervergleich

Je Kriterium 0 bis 3 Punkte: 0 fehlt, 1 behauptet, 2 gezeigt, 3 mit Belegen nachgewiesen.

| Kriterium | Anbieter A | Anbieter B | Anbieter C |
|---|---|---|---|
| Didaktik und Engineering aus einer Hand | [0-3] | [0-3] | [0-3] |
| KI-Fähigkeit: adaptive Lernpfade, Chatbot auf eigenem Wissen | [0-3] | [0-3] | [0-3] |
| DSGVO: Hosting in Deutschland oder der EU, AVV, Löschkonzept | [0-3] | [0-3] | [0-3] |
| Eigentum am Code und an den Inhalten nach Projektende | [0-3] | [0-3] | [0-3] |
| Betrieb und Weiterentwicklung nach dem Go-live | [0-3] | [0-3] | [0-3] |
| Referenzen mit Belegen statt Folien | [0-3] | [0-3] | [0-3] |
| **Summe von 18** | [Summe] | [Summe] | [Summe] |

#### 2. Vor der Angebotsanfrage klären

- [ ] Brauchen wir Content oder Software? Angebote dazu sind nicht vergleichbar.
- [ ] Wer sind die Nutzergruppen, und wie viele Personen je Gruppe?
- [ ] Welche Systeme müssen angebunden werden? [LMS, SSO, xAPI, SCORM, HR-System]
- [ ] Welche Inhalte liegen vor, in welchem Format?
- [ ] Wo müssen die Daten liegen?
- [ ] Wer betreibt die Lösung nach dem Go-live, wir oder der Anbieter?
- [ ] Budgetrahmen und gewünschter Go-live-Termin?

#### 3. Vor der Unterschrift schriftlich festhalten

- [ ] Eigentum am Quellcode und an den Inhalten
- [ ] Nutzungsrechte und Herausgabe des Quellcodes bei Vertragsende
- [ ] Auftragsverarbeitungsvertrag und Hostingstandort
- [ ] Wartung, Service-Level und Weiterentwicklung
- [ ] Umgang mit Trainingsdaten bei KI-Funktionen
- [ ] Was mit Ihren Daten bei einem Anbieterwechsel geschieht
...
Genau darauf ist unser Angebot ausgerichtet. Wie LearnSlice individuelle E-Learning-Software mit KI, EU-Hosting und Eigentum am Ergebnis umsetzt, sehen Sie auf der Seite zur [individuellen E-Learning-Entwicklung](/de/loesungen).
