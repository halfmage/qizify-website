...
keyTakeaways:
  - "Open-weight models (Kimi K2, gpt-oss, Qwen, Mistral, DeepSeek and others) are AI models whose weights you can download and run on your own infrastructure. That is the one class of frontier-adjacent AI you can fully self-host, so your data never leaves your servers and you are not billed per token."
...
|---|---|---|
| Where your data goes | to the provider, often outside the EU | stays on your own or EU infrastructure |
