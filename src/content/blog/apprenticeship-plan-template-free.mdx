---
title: "Free Apprenticeship Plan Template (§14 BBiG, Copy-Paste)"
description: "Free apprenticeship plan template aligned with § 14 BBiG: copy-paste sample, trainer checklist, and when to graduate to a dynamic, AI-powered plan."
...
faq:
  - q: "Is a free template enough to register the apprenticeship contract with the chamber?"
    a: "In most chamber districts yes, provided the template cleanly reflects the factual and temporal structure from the training ordinance and is submitted as an annex to the apprenticeship contract. Incompletely filled templates routinely trigger follow-up questions from the chamber."
  - q: "Is there an official apprenticeship plan template from the IHK?"
    a: "Many chambers publish sample apprenticeship plans per profession, often as Word or PDF. They are a good starting point but also only cover the framework, not your operational knowledge."
  - q: "Does the apprenticeship plan need to be signed?"
    a: "The BBiG does not explicitly require the written form for the plan itself, only for the apprenticeship contract. In practice it is standard to have the plan signed by the training employer, trainer, and apprentice as an annex to document acknowledgment."
  - q: "How often does the plan need to be updated?"
    a: "There is no fixed legal rhythm. Technically the plan should be adjusted promptly when processes, rotations, or responsible people change, and reviewed at minimum every six months."
  - q: "Is a digital template legally equivalent to the paper version?"
    a: "Yes. Neither the BBiG nor the individual training ordinances prescribe a specific form. A digitally maintained, versioned copy is actually more traceable in a dispute than a paper document."
  - q: "How does the apprenticeship plan relate to the training logbook?"
    a: "The plan is the planning layer; the training logbook (Berichtsheft under § 13 sentence 2 number 7 BBiG) is the documentation layer. A digital training logbook can reference the plan directly and make weekly progress traceable."
---
...
"Apprenticeship plan template free" is one of the most common searches in the German vocational training space, and for good reason. § 14 paragraph 1 number 1 of the Vocational Training Act ([BBiG](https://www.gesetze-im-internet.de/bbig_2005/__14.html)) requires every training company to run the apprenticeship "in a planned, temporally and factually structured" manner. Without a clean planning document the requirement isn't met, and the [IHK](https://www.ihk.de) (German Chamber of Commerce) verifies the completeness of the submitted documents when the apprenticeship contract is registered.
...
A detailed treatment of the approach - including why ChatGPT isn't a viable substitute - is in our guide [AI in vocational training](/blog/ai-in-vocational-training). A concrete comparison is in our [LearnSlice vs. traditional training](/learnslice-vs-traditional-training) analysis.
...
**A custom-built solution is the right route** when you are not training your own apprentices but preparing large groups for a regulated exam, when the processes are too specific for any standard software, or when the result has to belong to you. Our page on [custom e-learning development](/solutions) sets out how such a project runs.
...
Further reading: [AI in vocational training](/blog/ai-in-vocational-training) · [Digitize apprenticeship training](/blog/digitize-apprenticeship-training) · [Digital training logbook](/blog/digital-training-logbook) · [AI tools for vocational training](/blog/ai-tools-vocational-training)
